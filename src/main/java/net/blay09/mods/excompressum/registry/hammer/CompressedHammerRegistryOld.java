...
//public class CompressedHammerRegistryOld {
//
//    private static final Multimap<ItemAndMetadata, CompressedHammerReward> smashables = ArrayListMultimap.create();
//
//    private static void register(Block source, int sourceMeta, Item output, int outputMeta, float chance, float luckMultiplier) {
//        CompressedHammerReward entry = new CompressedHammerReward(source, sourceMeta, output, outputMeta, chance, luckMultiplier);
//        smashables.put(new ItemAndMetadata(source, sourceMeta), entry);
//    }
//
//    public static Collection<CompressedHammerReward> getSmashables(IBlockState state) {
//        return getSmashables(new ItemAndMetadata(state));
//    }
//
//    public static Collection<CompressedHammerReward> getSmashables(ItemStack itemStack) {
//        return getSmashables(new ItemAndMetadata(itemStack));
//    }
//
//    public static Collection<CompressedHammerReward> getSmashables(ItemAndMetadata itemInfo) {
...
//    }
//
//    public static Multimap<ItemAndMetadata, CompressedHammerReward> getSmashables() {
//        return smashables;
//    }
//
...
//        for(Map.Entry<ItemAndMetadata, CompressedHammerReward> entry : smashables.entries()) {
...
//    }
//
//    public static Collection<ItemStack> getRewards(IBlockState itemStack, float luck, Random rand) {
//        return Collections.emptyList();
//    }
//
//    public static Collection<ItemStack> getRewards(ItemStack itemStack, float luck, Random rand) {
//        return Collections.emptyList();
//    }
//}
