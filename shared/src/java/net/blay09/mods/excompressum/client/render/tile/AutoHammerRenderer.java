...
public class AutoHammerRenderer implements BlockEntityRenderer<AutoHammerBlockEntity> {
    ...
    public static AutoHammerRenderer normal(BlockEntityRendererProvider.Context context) {
        return new AutoHammerRenderer(context, false);
    }

    public static AutoHammerRenderer compressed(BlockEntityRendererProvider.Context context) {
