...
public class HeavySieveRegistry {
    ...
    public static void reload() {
        ...
        String[] generatedSiftables = config.getStringList("Generate Heavy Siftables", "registries", new String[]{
                ...
                "ExtraUtilities:cobblestone_compressed:12=minecraft:gravel:0:1:5", "excompressum:compressed_dust:2=minecraft:gravel:0:1:5",
                "ExtraUtilities:cobblestone_compressed:14=minecraft:sand:0:1:5", "excompressum:compressed_dust:3=minecraft:sand:0:1:2",
