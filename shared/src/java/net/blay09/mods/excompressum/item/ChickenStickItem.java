...
public class ChickenStickItem extends DiggerItem {
    ...
    public ChickenStickItem(Item.Properties properties) {
        super(0f, 0f, ChickenStickTier.INSTANCE, new HashSet<>(), properties.fireResistant().addToolType(ToolType.PICKAXE, Tiers.DIAMOND.getHarvestLevel()));
    }
    ...
    public void tryPlayChickenSound(LevelAccessor level, BlockPos pos) {
        if (level.getRandom().nextFloat() <= ExCompressumConfig.COMMON.chickenStickSoundChance.get()) {
