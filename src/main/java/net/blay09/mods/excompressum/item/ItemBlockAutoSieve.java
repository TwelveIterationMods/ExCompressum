...
public class ItemBlockAutoSieve extends ItemBlock {
    ...
    public void addInformation(ItemStack itemStack, EntityPlayer entityPlayer, List list, boolean flag) {
        ...
        if(tagCompound != null && tagCompound.hasKey("CustomSkin")) {
            ...
            if(customSkin != null) {
                list.add(TextFormatting.GRAY + I18n.format("tooltip.excompressum:auto_sieve", customSkin));
            }
        } else {
            if(currentRandomName == null) {
                currentRandomName = AutoSieveSkinRegistry.getRandomSkin();
            }
            list.add(TextFormatting.GRAY + I18n.format("tooltip.excompressum:auto_sieve", currentRandomName));
        }
