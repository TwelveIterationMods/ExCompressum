...
public class ModLoot {
    ...
    public static void initialize(BalmLootTables lootTables) {
        ...
        Registry.register(BuiltInRegistries.LOOT_POOL_ENTRY_TYPE, new ResourceLocation(ExCompressum.MOD_ID, "nihilo_item"), nihiloItemEntry = new LootPoolEntryType(new NihiloLootEntry.Serializer()));
    }
