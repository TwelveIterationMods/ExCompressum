...
public enum BaitType implements StringRepresentable {
    ...
    private final Supplier<ItemStack> displayItemFirst;
    private final Supplier<ItemStack> displayItemSecond;
    ...
    BaitType(Supplier<ItemStack> displayItemFirst, Supplier<ItemStack> displayItemSecond, EntityType<?> entityType, Supplier<Double> chanceSupplier, int primaryColor, int secondaryColor) {
    ...
    public ItemStack getDisplayItemFirst() {
        return displayItemFirst.get();
    }

    public ItemStack getDisplayItemSecond() {
        return displayItemSecond.get();
    }
