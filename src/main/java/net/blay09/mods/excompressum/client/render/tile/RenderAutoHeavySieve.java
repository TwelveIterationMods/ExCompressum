...
public class RenderAutoHeavySieve extends TileEntitySpecialRenderer {
    ...
    public static final ResourceLocation texture = new ResourceLocation(ExCompressum.MOD_ID, "textures/blocks/auto_compressed_hammer.png");
    ...
    public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float f) {
        ...
        biped.renderAll(tileEntitySieve.getCurrentStack() != null && tileEntitySieve.getEnergyStored(null) > tileEntitySieve.getEffectiveEnergy());
        GL11.glPopMatrix();
